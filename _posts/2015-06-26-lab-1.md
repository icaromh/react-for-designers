...
Unless you already have a JSBin account, <strong>head to <a href="http://jsbin.com/" target="_blank">jsbin.com</a> to create an account.</strong> Click **Login or Register** on the menu to create an account. <!-- markup clean_ -->
...
<a href="https://twitter.com/share" class="twitter-share-button" data-via="chibicode" data-size="large" data-dnt="true">Tweet</a>
