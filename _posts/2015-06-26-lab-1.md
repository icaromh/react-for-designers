...
<p class="jsbin-wrapper">
  <a class="jsbin-embed" href="http://jsbin.com/wewimu/6/embed?js,output">JS Bin on jsbin.com</a><script src="http://static.jsbin.com/js/embed.js"></script>
</p>
...
If you typed this correctly, then you should see the Tweet box on your JSBin. That's it for this step!
