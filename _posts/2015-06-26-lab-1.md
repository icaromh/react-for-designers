...
Unless you already have a JSBin account, <strong>head to <a href="http://jsbin.com/" target="_blank">jsbin.com</a><!-- markup clean_ --> to create an account.</strong> Click **Login or Register** on the menu to create an account.
...
Again, it has to do with React's style of writing UI code. In React, event handlers modify the magic "state", and whenever the state is modified, React automatically calls `render()` again to update the UI.
...
<blockquote class="twitter-tweet" lang="en"><p lang="en" dir="ltr">One of our attendees <a href="https://twitter.com/chibicode">@chibicode</a> posted a great <a href="https://twitter.com/hashtag/reactjs?src=hash">#reactjs</a> tutorial for those coming from jQuery <a href="http://t.co/IdelMFt7sO">http://t.co/IdelMFt7sO</a> <a href="https://t.co/kr4upM7RAP">https://t.co/kr4upM7RAP</a></p>&mdash; react-europe (@ReactEurope) <a href="https://twitter.com/ReactEurope/status/619067336323153920">July 9, 2015</a></blockquote>
