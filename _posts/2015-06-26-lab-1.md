...
Unless you already have a JSBin account, **head to [jsbin.com](http://jsbin.com/) to create an account.** Click **Login or Register** on the menu to create an account.
...
You seem to be pretty comfortable with JSBin now. Alright, let's build out a Tweet box. Still on the same JSBin as before, **change the HTML like this:**
...
To get this to work, **continue from the previous JSBin, open the JavaScript tab, and add the following jQuery code**. You don't need to add jQuery because Bootstrap adds jQuery automatically.
...
Let me show you what I mean. Here's the React.js code which displays the same Tweet box. **You don't need to follow along yet - just watch**.
