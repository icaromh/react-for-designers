...
And paste it into the Tweet box here:

<a class="jsbin-embed" href="http://jsbin.com/kuveba/2/embed?output">JS Bin on jsbin.com</a>
...
If we were to implement this in jQuery, our code will be even messier:
